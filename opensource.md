...
| In flight | [pytorch#196017](https://github.com/pytorch/pytorch/pull/196017) (`prune.remove` parameter order; Individual CLA signed 2026-09-05). [pydantic-ai#8012](https://github.com/pydantic/pydantic-ai/pull/8012) (agents, TestModel formats). [inspect_evals#2324](https://github.com/UKGovernmentBEIS/inspect_evals/pull/2324) (register da-verify; C0 logs uploaded 2026-08-30, awaiting maintainer). Then huggingface/trl. |
...
[inspect_evals#2320](https://github.com/UKGovernmentBEIS/inspect_evals/pull/2320) merged 2026-09-01. [peft#3647](https://github.com/huggingface/peft/pull/3647) merged 2026-09-04. September in-flight is [pytorch#196017](https://github.com/pytorch/pytorch/pull/196017) (Individual CLA signed 2026-09-05; not a merge), pydantic-ai, and the da-verify register. Then huggingface/trl. Do **not** open lm-eval as the next PR.
